...
export async function GET(
  ...
  try {
    ...
    const conversationId = Message.createChatId(
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        chatPartner: {
          ...
          name: (otherUser as any).username || (otherUser as any).name || '',
...
export async function POST(
  ...
  // Populate sender and recipient info (use correct field names)
  await message.populate('senderId', 'username email profilePicture');
  await message.populate('receiverId', 'username email profilePicture');
    ...
    return NextResponse.json({
      ...
      data: {
        message: message.toObject(),
        conversationId: (message as any).chatId
      }
    });
