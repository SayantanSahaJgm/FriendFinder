  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white ff-white ff-white transform translate-x-1/2 -translate-y-1/2 bg-red-500 rounded-full min-w-[1.25rem]">
            {unreadCount}
          </span>
        )}
      </button>
                          ...
                          {notification.type === "friend_request" && (
                            <div className="flex space-x-2 mt-3">
                              <button
                                ...
                                className="flex items-center space-x-1 px-2 py-1 bg-green-500 text-white ff-white ff-white text-xs rounded hover:bg-green-600"
                              >
                              ...
                              <button
                                ...
                                className="flex items-center space-x-1 px-2 py-1 bg-red-500 text-white ff-white ff-white text-xs rounded hover:bg-red-600"
                              >
                                <X className="w-3 h-3" />
                                <span>Reject</span>
                              </button>
